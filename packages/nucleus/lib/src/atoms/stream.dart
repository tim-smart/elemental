...
AtomBase<FutureValue<A>> streamAtom<A>(
...
Tuple2<AtomBase<FutureValue<A>>, AtomBase<Stream<A>>> streamAtomTuple<A>(
  AtomReader<Stream<A>> create, {
  A? initialValue,
  bool? keepAlive,
}) {
  final stream = derivedAtom(create, keepAlive: keepAlive);
